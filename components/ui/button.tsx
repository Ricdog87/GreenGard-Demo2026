...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-sans font-medium transition-all duration-300 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-forest/40 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        primary: 'bg-forest text-linen hover:bg-ink rounded-full',
        accent: 'bg-bronze text-linen hover:bg-[#9e6228] rounded-full',
        outline: 'border border-ink/15 text-ink hover:border-ink/40 bg-transparent rounded-full',
        ghost: 'text-ink hover:bg-linen rounded-full',
        link: 'text-ink underline underline-offset-4 decoration-mist hover:decoration-ink p-0 h-auto',
        destructive: 'bg-red-700 text-white hover:bg-red-800 rounded-full',
      },
      size: {
        sm: 'h-9 px-4',
        md: 'h-11 px-6',
